...
public class Connection
{
   ...
   */
   private void connect(String key)
   {
      if (key.equals("#"))
      {
         System.out.println(accumulatedKeys);
         if(accumulatedKeys == "" || !("0123456789").contains(accumulatedKeys)){
   ...
   /**
   after connection established now choose what the user want
    */
   private void userChoice(){
      System.out.println("To leave a message to mailbox, press (1), to access your mailbox, press (2)");
   ...
   */
   ...
   {
      System.out.println("Press (1) to get to your messages, press (2) to change your passcode, press (3)" +
